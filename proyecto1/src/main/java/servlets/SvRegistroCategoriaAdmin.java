 ...
 * @author HP
 */
@WebServlet(name = "SvRegistroCategoriaAdmin", urlPatterns = {"/SvRegistroCategoriaAdmin"})
public class SvRegistroCategoriaAdmin extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        //OptionPane.showMessageDialog(null,cursoSeleccionado ); //Para probar si se guardan los datos en session
        //JOptionPane.showMessageDialog(null,nombreCategoria );
        // ****** FALTA hacer una categoria y guardarla en db, la descripcion 
    }
